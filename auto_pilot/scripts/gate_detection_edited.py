...
class gate_detector:
    ...
    def image_rect(self, data):
        try:
            ...
            self.is_img = 1
            #img_rect = CvBridge().compressed_imgmsg_to_cv2(data)
            #cv_image = img_rect.copy()
            # self.making_depth()
    ...
    def ir_subscribe(self, data):
        ...
        if(is_marker_detected):
            ...
            if tot_point == 0:
                ...
                self.center_point[0] = img_center_x
                self.center_point[1] = img_center_y
                # visible_point = np.where(marker_point == 1)
                # if visible_point[0][0] == 0:
                #     self.center_point[0] = int(target_point[visible_point[0][0]][0] + 10)
                #     self.center_point[1] = int(target_point[visible_point[0][0]][1] + 10)
                # elif visible_point[0][0] == 1:
                #     self.center_point[0] = int(target_point[visible_point[0][0]][0] - 10)
                #     self.center_point[1] = int(target_point[visible_point[0][0]][1] + 10)
                # elif visible_point[0][0] == 2:
                #     self.center_point[0] = int(target_point[visible_point[0][0]][0] - 10)
                #     self.center_point[1] = int(target_point[visible_point[0][0]][1] - 10)
                # elif visible_point[0][0] == 3:
                #     self.center_point[0] = int(target_point[visible_point[0][0]][0] + 10)
                #     self.center_point[1] = int(target_point[visible_point[0][0]][1] - 10)
